...
import { PersonsList } from "@/app/locations/locationsPageComponents/PesrsonsList";
// import "./castom.css";
...
export const EpisodeCard = (props: LocationPops) => {
  ...
  return (
    ...
    >
      ...
      <p className={`text-[#666666] ${hideElement}`}>{airDate}</p>
      <p className={`text-[#666666] ${hideElement}`}>{episode}</p>
      ...
      >
        <p className='flex flex-col text-base font-bold text-[#081F32]'>
          Type{" "}
          <span className='font-normal text-[#6E798C] text-sm'>{airDate}</span>
        </p>{" "}
        <p className='flex flex-col text-base font-bold text-[#081F32]'>
          Dimension{" "}
          <span className='font-normal text-[#6E798C] text-sm'>{episode}</span>
        </p>
      </div>
